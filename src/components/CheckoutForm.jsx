    ...
    <form onSubmit={handelSubmit} className="bg-[#F3F3F3] p-4 rounded-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="date" name="date" className="input w-full border-0" />
        </div>
        {/* phone */}
        <div>
          <label htmlFor="price">Phone</label>
          <input type="number" name="phone" className="input w-full border-0" />
        </div>
        {/* address */}
        <div>
          <label htmlFor="address">Address</label>
          <input type="text" name="address" className="input w-full border-0" />
        </div>
      </div>
